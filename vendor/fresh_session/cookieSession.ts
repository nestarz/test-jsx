...
export class CookieSessionStorage {
  ...
  get(sessionId: string) {
    const [, payload] = decode<any>(sessionId);
...
export function cookieSession(cookieOptions?: CookieOptions) {
  return async function (
    req: Request,
    ctx: FreshContext<{ session: Session }>,
  ): Promise<Response> {
